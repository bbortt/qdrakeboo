...
export type RequestUserInfoAction = { type: string, sessionCookie: string | null }
...
export function requestUserInfo(sessionCookie: string): RequestUserInfoAction {
  return {type: REQUEST_USER_INFO, sessionCookie: sessionCookie}
}
