package io.github.bbortt.qdrakeboo.model.autoconfiguration.domain;
...
public abstract class AbstractAuditingEntity implements Serializable {
  ...
  public String toString() {
    return new ToStringBuilder(this).append("created", created).append("lastUpdated", lastUpdated)
        .build();
  }
}
